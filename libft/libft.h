...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/19 13:06:17 by alara-pe          #+#    #+#             */
/*   Updated: 2023/06/26 19:55:07 by alara-pe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strlcpy(char *dest, const char *s1, size_t len);
size_t	ft_strlen(const char *str);
int		ft_strncmp(const char *str1, const char *s2, size_t len);
